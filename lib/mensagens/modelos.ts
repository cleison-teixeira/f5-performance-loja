export const ORDENS_POR_MODELO: Record<1 | 2 | 3 | 4 | 5, number[]> = {
  ...
  5: [1, 2, 3, 4, 5], // Agradecimento + Relacionamento + Recompra + Oferta + Follow-up
}
...
export const MODELO_OPTIONS: { value: 1 | 2 | 3 | 4 | 5; label: string; tipos: string }[] = [
  ...
  { value: 5, label: '5 mensagens', tipos: 'Agradecimento + Relacionamento + Recompra + Oferta + Follow-up' },
]
